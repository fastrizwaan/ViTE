...
/* CSS ported from vitetab.py + Separator (GTK4 / Libadwaita safe) */
...
"    outline: none;"
"}"
"flowbox box.vite-tab:drop(active) {"
"    border: none;"
"    box-shadow: none;"
"    outline: none;"
"}"
...
"    background-color: mix(@headerbar_bg_color, @window_fg_color, 0.06);"
"}"
"box.vite-tab.active {"
...
"}"
".vite-tab-fade {"
"    background-image: linear-gradient(to right, transparent 30%, @headerbar_bg_color 100%);"
"    min-width: 15px;"
"    opacity: 1;"
...
"        mix(@headerbar_bg_color, @window_fg_color, 0.06) 60%, "
"        mix(@headerbar_bg_color, @window_fg_color, 0.06) 100%);"
"}"
"box.vite-tab.active .vite-tab-fade {"
"    background-image: linear-gradient(to right, transparent 0%, "
"        mix(@headerbar_bg_color, @window_fg_color, 0.08) 60%, "
"        mix(@headerbar_bg_color, @window_fg_color, 0.08) 100%);"
"}"
"box.vite-tab.active:hover .vite-tab-fade {"
"    background-image: linear-gradient(to right, transparent 0%, "
"        mix(@headerbar_bg_color, @window_fg_color, 0.12) 60%, "
"        mix(@headerbar_bg_color, @window_fg_color, 0.12) 100%);"
"}"
...
"}"
/* Backdrop: inactive tabs fully transparent, active tab gets subtle hint */
"window:backdrop box.vite-tab,"
"window:backdrop box.vite-tab:hover {"
"    background-color: transparent;"
"}"
"window:backdrop box.vite-tab.active,"
"window:backdrop box.vite-tab.active:hover {"
"    background-color: mix(@headerbar_bg_color, @window_fg_color, 0.04);"
"}"
"window:backdrop .vite-tab-fade,"
"window:backdrop box.vite-tab:hover .vite-tab-fade {"
"    background-image: none;"
"}"
"window:backdrop box.vite-tab.active .vite-tab-fade,"
"window:backdrop box.vite-tab.active:hover .vite-tab-fade {"
"    background-image: linear-gradient(to right, transparent 0%, "
"        mix(@headerbar_bg_color, @window_fg_color, 0.04) 60%, "
"        mix(@headerbar_bg_color, @window_fg_color, 0.04) 100%);"
"}"
"window:backdrop .vite-tab-close-button,"
"window:backdrop .vite-tab.active .vite-tab-close-button {"
"    background-color: transparent;"
"}"
"window:backdrop .vite-tab-separator {"
"    background-color: transparent;"
"}";
