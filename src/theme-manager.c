...
static const ScopeMapping scope_map[] = {
    ...
    { "keyword.control.import",        COLOR_PREPROC },
    { "keyword.control.from",          COLOR_PREPROC },
    { "keyword.control.as",            COLOR_PREPROC },
    { "keyword.control.flow",          COLOR_KEYWORD_CONTROL },
    { "keyword.control",               COLOR_KEYWORD_CONTROL },
    { "keyword.function",              COLOR_KEYWORD_CONTROL },
    { "keyword.other.unit",            COLOR_NUMBER },
    { "keyword",                       COLOR_KEYWORD },
    { "storage.type.function",         COLOR_KEYWORD_CONTROL },
    { "storage.type.class",            COLOR_KEYWORD_CONTROL },
    ...
    { "variable.other.readwrite.alias",COLOR_VARIABLE },
    { "variable.other.readwrite",      COLOR_VARIABLE },
    ...
    { "support.function.builtin",      COLOR_BUILTIN },
    { "support.function.magic",        COLOR_BUILTIN },
